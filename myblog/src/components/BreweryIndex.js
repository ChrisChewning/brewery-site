...
console.log(this.state.closestThree)
  return (
      ...
      <Card className="brewery-index-map-parent">
        ...
        <div className="brewery-index-map">
          <LocationOnOutlinedIcon className="brewery-index-location-icon"/>
          <p className="brewery-index-beer-hours-list">{this.state.address} </p>
        </div>
